...
export const getUserInfo = async(req, res) => {
    try {
        ...
        console.log("Error in user controller, getUserInfo function: ", error.message);
...
export const follow = async (req, res) => {
    ...
    try {
      ...
      if (userToFollow.followers.includes(userId)) {
        //Unfollow
        userToFollow.followers = userToFollow.followers.filter(followerId => !followerId.equals(userId));
        userThatFollows.following = userThatFollows.following.filter(followingId => !followingId.equals(userToFollowId));
      } else {
        //Follow
